...
| Ours — `replace`, paste jitter off (n=3) | 3,644 | 911 | 55.78 ± 0.38 | 51.60 ± 0.36 | 61.10 ± 0.50 | 58.80 ± 0.74 | 71.38 ± 0.52 |
| Ours — `replace` + jitter `low` (n=3) | 3,644 | 911 | 56.20 ± 0.34 | 52.04 ± 0.13 | 61.55 ± 0.78 | 59.09 ± 0.19 | 71.85 ± 0.51 |
| **Ours — `replace` + jitter `mid` (기본값, n=3)** | 3,644 | 911 | **56.69 ± 0.15** | **52.59 ± 0.08** | **61.86 ± 0.42** | **60.03 ± 0.21** | **72.57 ± 0.25** |
...
- **붙이는 crop에는 프레임마다 다른 jitter가 걸립니다**(`paste_jitter`, 기본 `mid`). color ·
  ...
  픽셀 단위로 외우는 것을 막습니다. 측정값은 위 Results 참고(HOTA +0.91 vs jitter off).
